...
function CharacterPane:OnDBReady()
    ...
    -- Try to skin immediately if CharacterFrame exists
...
function CharacterPane:PLAYER_ENTERING_WORLD()
    -- Try to skin after entering world
...
local function RepositionEquipmentSlots()
    ...
    if mainHandSlot and not mainHandSlot._abstractRepositioned then
        ...
        mainHandSlot:SetPoint("TOPLEFT", PaperDollItemsFrame, "TOPLEFT", 150, -370)
    ...
    if offHandSlot and not offHandSlot._abstractRepositioned then
        ...
        offHandSlot:SetPoint("TOPLEFT", PaperDollItemsFrame, "TOPLEFT", 210, -370)
...
local function SkinCharacterFrameBackdrop()
    ...
    if not CharacterFrame.AbstractScaleBox then
        ...
        scaleBox:SetFont("Fonts\\FRIZQT__.TTF", 10, "OUTLINE")
