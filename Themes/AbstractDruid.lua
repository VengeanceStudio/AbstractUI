-- AbstractUI Theme: Abstract Druid
-- Based on Abstract Transparent with Druid class color text (#FF7C0A)
...
ColorPalette:RegisterPalette("AbstractDruid", {
    ...
    ["panel-border"] = {r = 0.302, g = 0.145, b = 0.012, a = 0.90}, -- Dark Druid orange (#4D2503)
    ...
    ["text-primary"] = {r = 1.0, g = 0.486, b = 0.039, a = 1.0},   -- Druid class color (#FF7C0A)
