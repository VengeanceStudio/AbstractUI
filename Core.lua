        ...
        args = {
            general = {
                ...
                args = {
                    ...
                    minimapButtons = { name = "Minimap Button Bar", type = "toggle", order = 2.41, width = "normal",
                        get = function() return self.db.profile.modules.minimapButtons end,
                        set = function(_, v) self.db.profile.modules.minimapButtons = v; StaticPopup_Show("AbstractUI_RELOAD_CONFIRM") end },
